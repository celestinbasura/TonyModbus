...
public class Garden extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headline.setText("Reticulation");


        pointListHelper.add(new ModBusPoint("Alfresco Garden", 0, registerOffset));
        pointListHelper.add(new ModBusPoint("Rear", 4, registerOffset)); //first int is the status reg value, second is the timer address
        pointListHelper.add(new ModBusPoint("Front Left", 8, registerOffset));

        pointListHelper.add(new ModBusPoint("Front Left", 12, registerOffset));
        pointListHelper.add(new ModBusPoint("Verge", 16, registerOffset));




        userAdapter = new PointAdapterAlarmGarden(Garden.this, R.layout.point_list_on_off, pointListHelper);
